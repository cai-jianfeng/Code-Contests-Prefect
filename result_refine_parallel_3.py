...
class SandboxSession:
    ...
    def call_api(self, api_path: str, payload: Dict) -> Dict:
        """调用远程的 sandbox API"""
        try:
            ...
            print(f"Error calling sandbox API {api_path}: {e}")
            return {"error": str(e), "status": "failed"}
        except Exception as e:
            print(f"Unexpected error calling sandbox API {api_path}: {e}")
            return {"error": str(e), "status": "failed"}
...
def main():
    """主函数"""
    # 配置参数
    result_folder = "/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_ours_all_solutions_o4mini_10maxsample_repeat_2/"
    data_folder = "/aiarena/group/llmgroup/caijf/Code-Contests-Ours/test_all_solutions_o4mini_10maxsample_repeat_2/"
