...
def main():
    """主函数"""
    # 配置参数
    result_folder = "/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_plus_5x/"
    data_folder = "/aiarena/gpfs/Code-Contests-Uni/test/test_dataset_filtered_with_1_3_5_test_cases/"
    ...
    dataset = dataset_read(data_folder, "codecontents_plus", split='3x')
