...
if __name__ == "__main__":
    ...
    results_path = f"/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_only_generate_retry"
    time_consume_path = f"/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_only_generate_retry.txt"
    # 获取初始时间
