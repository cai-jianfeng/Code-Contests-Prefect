...
if __name__ == "__main__":
    ...
    codecontests_data_path = "/aiarena/gpfs/Code-Contests-Uni/test/test_dataset_filtered_with_1_3_5_test_cases"
    # codecontests_data_path = "/aiarena/gpfs/Code-Contests-Ours/test_all_solutions_o4mini_10maxsample/"
    ...
    for i in range(sandbox_num):
        ...
        sandbox_api_paths.append(f"http://10.244.179.30:{8080+i}/submit")
        sandbox_api_paths.append(f"http://10.244.188.165:{8080+i}/submit")
        sandbox_api_paths.append(f"http://10.244.204.77:{8080+i}/submit")
        sandbox_api_paths.append(f"http://10.244.128.93:{8080+i}/submit")
        sandbox_api_paths.append(f"http://10.244.81.198:{8080+i}/submit")  # 128 CPU
    ...
    dataset = dataset_read(codecontests_data_path, "codecontents_plus", split='5x')
    start = 0
    end = len(dataset)
    ...
    results_path = f"/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_plus_5x/"
    time_consume_path = f"/aiarena/group/llmgroup/caijf/final_ut_gen/code_contests_plus_5x.txt"
    # 获取初始时间
