...
public:
    ...
    /* Overload to accept size_t second argument, to avoid ambiguity with unsigned container sizes */
    int next(int from, size_t to) {
        return next(from, static_cast<int>(to));
    }
